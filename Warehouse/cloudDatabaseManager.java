...
public class cloudDatabaseManager 
{
    ...
    public boolean changeStatus(int n, String status)
    {
        try 
        {
            this.st.execute("UPDATE database.orders SET orderStatus = " + status + " WHERE orderNumber = " + n + "'); ");
            return true;
        }
        catch (Exception ex) 
        {
    ...
    public boolean remove(int n)
    {
        try 
        {
            this.st.execute("DELETE FROM database.orders WHERE id = " + n);
            return true;
        }
        catch (Exception ex) 
        {
    ...
    public Order getOrder(int n) 
    {
        ...
        try
        {
            this.rs = this.st.executeQuery("SELECT * FROM database.orders WHERE orderNumber = " + n);
